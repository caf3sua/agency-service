 ...
 */
@Entity
@Table(name="MOTO_HONDA")
@Getter
@Setter
public class MotoHonda implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="ID", unique=true)
	@GenericGenerator(name = "STRING_SEQUENCE_GENERATOR", strategy = "com.baoviet.agency.utils.StringSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "MOTO_HONDA_SEQ") })
	...
	@Column(name="NNTX_SO_NGUOI")
	private Integer nntxSoNguoi;

	@Column(name="NNTX_STBH")
	...
	@Column(name="GOI_BAO_HIEM")
	private String goiBaoHiem;
	
	@Column(name="DUNG_TICH_XE")
	private String dungTichXe;
