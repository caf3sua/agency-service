...
/**
 * The persistent class for the PA database table.
 * 
 */
@Entity
@Getter
...
public class Pa implements Serializable {
	...
	@GenericGenerator(name = "STRING_SEQUENCE_GENERATOR", strategy = "com.baoviet.agency.utils.StringSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "PA_SEQ") })
	...
	private Integer permanentPartDisablement;
