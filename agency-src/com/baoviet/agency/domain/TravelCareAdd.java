...
/**
 * The persistent class for the TRAVEL_CARE_ADD database table.
 * 
 */
@Entity
@Table(name="TRAVEL_CARE_ADD")
@Getter
@Setter
public class TravelCareAdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="TVC_ADD_ID", unique=true)
	@GenericGenerator(name = "STRING_SEQUENCE_GENERATOR", strategy = "com.baoviet.agency.utils.StringSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "TRAVEL_CARE_ADD_SEQ") })
