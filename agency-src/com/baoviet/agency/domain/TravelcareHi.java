 ...
 */
@Entity
@Table(name="TRAVELCARE_HIS")
@Getter
@Setter
public class TravelcareHi implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="TRAVELCARE_ID", unique=true)
	@GenericGenerator(name = "STRING_SEQUENCE_GENERATOR", strategy = "com.baoviet.agency.utils.StringSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "TRAVELCARE_HIS_SEQ") })
