...
/**
 * The persistent class for the TVICARE database table.
 * 
 */
@Entity
@Table(name="TVICARE")
@Getter
@Setter
public class Tvicare implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@Column(name="TVICARE_ID", unique=true)
	@GenericGenerator(name = "STRING_SEQUENCE_GENERATOR", strategy = "com.baoviet.agency.utils.StringSequenceGenerator", parameters = { @Parameter(name = "sequence", value = "TVICARE_SEQ") })
