...
public class TvicareDTO implements Serializable {
	...
	private String departureId = AgencyConstants.DEFAULT_STRING_VALUE;

	private String departureName = AgencyConstants.DEFAULT_STRING_VALUE;
	...
	// More properties
    private String userAgent = AgencyConstants.DEFAULT_STRING_VALUE;
}