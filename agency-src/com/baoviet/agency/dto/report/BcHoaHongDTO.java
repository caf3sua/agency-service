...
@NamedStoredProcedureQueries({
	   @NamedStoredProcedureQuery(name = "bc_hoa_hong", 
           procedureName = "BAO_CAOPackage.REPORT_COMMISSION",
 		   resultSetMappings = {"bc_hoa_hong_mapping"},
           parameters = {
...
@SqlResultSetMappings({
	@SqlResultSetMapping(name= "bc_hoa_hong_mapping", classes = {
	        @ConstructorResult(targetClass = BcHoaHongDTO.class,
	            columns = {
...
public class BcHoaHongDTO implements Serializable {
	...
	public BcHoaHongDTO(String datePayment, Long totalPremium, Long hoaHongSale, Long hoaHongTruongDv, Long hoaHongDv,
			Long tongHoaHong) {
		super();
