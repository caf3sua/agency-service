...
@NamedStoredProcedureQueries({
	   @NamedStoredProcedureQuery(name = "bc_hoahong_bvp_sale", 
           procedureName = "BAO_CAOPackage.BC_HOAHONG_BVP_SALE",
 		   resultSetMappings = {"bc_hoahong_bvp_sale_mapping"},
           parameters = {
...
@SqlResultSetMappings({
	@SqlResultSetMapping(name= "bc_hoahong_bvp_sale_mapping", classes = {
	        @ConstructorResult(targetClass = BcHoahongBvpSaleDTO.class,
	            columns = {
...
public class BcHoahongBvpSaleDTO implements Serializable {
	...
	public BcHoahongBvpSaleDTO(String baovietCompanyName, String tenKhachHang, String tenNdbh, String soGycbh,
			String sendDate, String trangThaiHd, String soHd, String soGcn, String thbhTu, String thbhDen, Long phiBh,
			Long tangGiamPhi, Long phiPhaiThu, Long phiThucThu, String ngayNopPhi, String ngayCapDon, String soGiaoDich,
			String ghiChu, Long hoaHongSale) {
		super();
