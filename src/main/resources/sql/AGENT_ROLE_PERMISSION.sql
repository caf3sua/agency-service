  ...
  TABLESPACE "SM_SYSTEMSMARTAPP"  ENABLE, 
	 CONSTRAINT "FK_RO_ROLE" FOREIGN KEY ("ROLE_NAME")
	  REFERENCES "TRADEOL"."AGENT_ROLE" ("NAME") ENABLE, 
	 CONSTRAINT "FK_RO_PERMISSION" FOREIGN KEY ("PERMISSION_NAME")
	  REFERENCES "TRADEOL"."AGENT_PERMISSION" ("NAME") ENABLE
